...
This directory capture the steps to enable Vuetify 4.x into trame-vuetify.

## Environment variables

```bash
export SRC_URL=https://cdn.jsdelivr.net/npm
export DST_PATH=../../trame_vuetify/module/v4-serve
export VUETIFY=vuetify@4.2.1
...
```bash
curl $SRC_URL/$VUETIFY/dist/vuetify.min.css -Lo $DST_PATH/vuetify4.css
curl $SRC_URL/$VUETIFY/dist/vuetify.min.js -Lo $DST_PATH/vuetify4.js
```
