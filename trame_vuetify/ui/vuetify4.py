...
class SinglePageLayout(VAppLayout):
    ...
    def __init__(self, _server, template_name="main", **kwargs):
        ...
        with self:
            with vuetify4.VAppBar() as toolbar:
                self.toolbar = toolbar
                self.icon = vuetify4.VAppBarNavIcon()
                self.title = vuetify4.VToolbarTitle("Trame application")

            self.content = vuetify4.VMain()

            with vuetify4.VFooter(app=True, classes="my-0 py-0", border=True) as footer:
                self.footer = footer
                vuetify4.VProgressCircular(
                ...
                if reload.exists():
                    with vuetify4.VBtn(
                        ...
                        vuetify4.VIcon("mdi-autorenew", size="small")

                with vuetify4.VTooltip(location="top"):
...
class SinglePageWithDrawerLayout(SinglePageLayout):
    ...
    def __init__(
        ...
        with self:
            self.drawer = vuetify4.VNavigationDrawer(
